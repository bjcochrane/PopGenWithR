...
R, on the other hand, has a couple of advantages:

###  It is an object oriented programming language,
so virtually any data can be input in some form or another.  For example, one can directly read data from HapMap, SNPData, and other such data bases, and with some manipulation (a. k. a. munging) get them into a format that can be used for a wide variety of applications.
### R does data.
For those who remember the days of having to wrestle with subscript indicese in languages like FORTRAN and BASIC, R is a delight.  For example, suppose you wish to create a vector of integers from 1:100.  It is as easy as
...
>* ape, pegas and adegent - provide essential functions for population genetic analysis and tree manipulation
