...
In diploids particular allele (call it a) can exist in one of two states - either in a homozygote or a heterozygote.  If its frequency is q, and the size of the population is N, then there are 2N copies of the allele, and the number that are in homozygotes is simply 2Np^2^.  Thus, we can determine the fraction of a alleles that occur in homozygotes to be
