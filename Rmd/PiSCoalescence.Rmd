...
So what is &u;?  There are lots of estimates out there, but we can use one estimated by @Haag2007 based on actual quantitation of mutations that occurred in a controlled laboratory system.  That estimate is 8.4*10^-9^/generation, so we calculate as follows:
