...
So what is &u;?  There are lots of estimates out there, but we can use one estimated by [Haag-Liautard et al (2007)](http://www.nature.com/nature/journal/v445/n7123/abs/nature05388.html) based on actual quantitation of mutations that occurred in a controlled laboratory system.  That estimate is 8.4*10^-9^/generation, so we calculate as follows:
