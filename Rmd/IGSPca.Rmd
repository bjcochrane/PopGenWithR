...
segments(.57,.8,.77,.5,lty=2,col="blue")
```
...
```{r}
samp3.pr <-princomp(dat.samp3[,2:4])
biplot(samp3.pr,var.axes=TRUE)
summary(samp3.pr)
```
...
PCA is an example of what data scientists call "unsupervised learing". If you are interested in learning more, this video is an excellent overview of the method:
