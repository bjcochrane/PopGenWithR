...
1.  The "struggle to measure variation" @Lewontin1974 is over.  In the era of thousands of human genomes and 101 dog genomes, detection and quantitation of genetic variation is no longer an experimental challenge (although making the genotype-phenotype connection remains one).
