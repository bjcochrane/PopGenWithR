...
url.ped <-download_url(id='10255/dryad.58625')
dryad_fetch(url.ped,destfile = "./Data/dryad.test")
...
Resistance ~ &mu; Size + a + station + site + station:site + &epsilon;
