...
The problem at the time (1980 or thereabouts) was that in all of this, we are assuming that we can detect every allele, and with electrophoresis as our tool, that is not possible.  However, Jerry Coyne in Richard Lewontin's lab developed a technique known as sequential electrophoresis, that came close to meeting this assumption.  Keith et al [-@Keith1985] applied the technique to the Xdh locus in 89 lines of *Drosophila pseudoobscura* and obtained the following results:
