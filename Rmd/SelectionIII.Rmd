...
3.  The mutation rate for the gene or genes in question 
...
![MK](https://dl.dropboxusercontent.com/u/9752688/QPopgen/figs/MK.png)
...
The function MK does the above analysis:
...
2.  FI is positive, suggesting a deficiency of nonsynonymous polymorphisms (something that should be evident based on visual inspection of the data)
...
The basic mathematics is extremely simple.  In fact, if we look at the MK function
