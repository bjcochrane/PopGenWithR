...
1. [Why R (and R Studio)?](https://dl.dropboxusercontent.com/u/9752688/PopGenWithR/html/Intro2R.html)
...
3. [Drift, Mutation and the Infinite Alleles Model](https://dl.dropboxusercontent.com/u/9752688/PopGenWithR/html/InfiniteSites.html)
...
7.  [The Fay-Wu Statistic](https://dl.dropboxusercontent.com/u/9752688/PopGenWithR/html/FayWu.Rmd)
...
### Exploratory materials (links to R code only)

1.  [Selection detection via coalescent simulation in guppies](https://dl.dropboxusercontent.com/u/9752688/PopGenWithR/html/GuppyOpsinSelection.Rmd)
